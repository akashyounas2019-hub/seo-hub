...
export const CONNECTED_SITES: ConnectedSite[] = [
  {
    ...
    topQueries: [
      { q: "dubai cleaning services", clicks: 842, imp: 12400, ctr: 6.8, pos: 3.2, delta: 12 },
      { q: "sofa cleaning dubai price", clicks: 612, imp: 9800, ctr: 6.2, pos: 4.1, delta: 8 },
      { q: "deep cleaning company near me", clicks: 498, imp: 7200, ctr: 6.9, pos: 2.8, delta: 22 },
      { q: "move in cleaning dubai", clicks: 341, imp: 5600, ctr: 6.1, pos: 5.4, delta: -3 },
      { q: "villa sanitization services uae", clicks: 287, imp: 4900, ctr: 5.9, pos: 6.7, delta: 15 },
    ],
    topPages: [
