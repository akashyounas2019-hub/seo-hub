    ...
    tabs: [
      {
        ...
        label: "Content Ideas",
        icon: Sparkles,
        summary: "Rolling backlog of angles sourced from SERPs, forums, and support tickets.",
        metrics: [
          { label: "Ideas in backlog", value: "96" },
          { label: "Approved", value: "34" },
          { label: "This week", value: "12", delta: "+4" },
        ],
        activity: [
          { time: "5m", text: "New angle: ‘moving with pets in UAE summer’" },
          { time: "1h", text: "Rejected 3 low-intent listicle ideas" },
          { time: "yday", text: "Imported 18 questions from Reddit r/dubai" },
        ],
      },
      {
        id: "calendar",
        ...
        icon: Calendar,
        summary: "Publishing plan aligned with seasonality and keyword momentum.",
        metrics: [
          { label: "Scheduled", value: "22" },
          { label: "In draft", value: "7" },
          { label: "Slippage", value: "1", delta: "at risk" },
        ],
        activity: [
          { time: "20m", text: "Locked Aug editorial calendar" },
          { time: "2h", text: "Shifted ‘packing hacks’ to peak-move week" },
          { time: "yday", text: "Booked 3 guest posts for Sep" },
        ],
      },
      {
        id: "briefs",
        label: "Brief Builder",
        icon: FileText,
        summary: "Structured briefs with H-outline, entities, and internal links.",
        metrics: [
          { label: "Briefs ready", value: "9" },
          { label: "Avg. entities", value: "38" },
          { label: "Time saved", value: "6.4h" },
        ],
        activity: [
          { time: "12m", text: "Brief drafted: ‘villa move checklist’" },
          { time: "1h", text: "Injected 22 internal link suggestions" },
          { time: "3h", text: "Handed 2 briefs to writers" },
        ],
      },
      {
        id: "audit",
        label: "Content Audit",
        icon: FileSearch,
        summary: "Score every URL for freshness, depth, and ranking decay.",
        metrics: [
          { label: "URLs audited", value: "312" },
          { label: "Refresh queue", value: "28" },
          { label: "Prune candidates", value: "11" },
        ],
        activity: [
      ...
      },
      {
        ...
        label: "Performance",
        icon: BarChart3,
        summary: "Traffic, engagement, and conversion by content cluster.",
        metrics: [
          { label: "Sessions / wk", value: "18.4k", delta: "▲ 12%" },
          { label: "Avg. dwell", value: "2m 41s" },
          { label: "Assist conv.", value: "184" },
        ],
        activity: [
          { time: "15m", text: "Cluster ‘office movers’ +32% w/w" },
          { time: "1h", text: "Top exit: /pricing — sent to CRO backlog" },
          { time: "yday", text: "Newsletter drove 1.2k assisted clicks" },
        ],
      },
    ],
  },
