...
const SITES: Site[] = [
  ...
  },
  {
    ...
    lastSync: "18 min ago",
    integrations: [
      { id: "gsc", name: "Search Console", icon: Search, status: "connected", detail: "5 coverage issues", accent: "from-emerald-400 to-teal-500" },
      { id: "ga4", name: "Analytics 4", icon: BarChart3, status: "action", detail: "Data stream inactive", accent: "from-amber-400 to-orange-500" },
      { id: "gmb", name: "Business Profile", icon: MapPin, status: "connected", detail: "Verified · 2 locations", accent: "from-rose-400 to-pink-500" },
      { id: "wp", name: "WP Connector", icon: Zap, status: "connected", detail: "REST · v6.5.1", accent: "from-sky-400 to-blue-500" },
    ],
  },
  {
    id: "atlas-outdoor",
    ...
    lastSync: "just now",
    integrations: [
      { id: "gsc", name: "Search Console", icon: Search, status: "connected", detail: "Syncing hourly · 412 URLs", accent: "from-emerald-400 to-teal-500" },
      { id: "ga4", name: "Analytics 4", icon: BarChart3, status: "connected", detail: "Property 774021", accent: "from-amber-400 to-orange-500" },
      { id: "gmb", name: "Business Profile", icon: MapPin, status: "disconnected", detail: "Ecommerce · not required", accent: "from-rose-400 to-pink-500" },
      { id: "wp", name: "WP Connector", icon: Zap, status: "connected", detail: "Shopify · Custom app", accent: "from-sky-400 to-blue-500" },
    ],
  },
];
